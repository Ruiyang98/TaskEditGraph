...
QT_MOC_LITERAL(1, 10, 9), // "taskAdded"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "index"
QT_MOC_LITERAL(4, 27, 11), // "taskRemoved"
QT_MOC_LITERAL(5, 39, 11), // "taskUpdated"
QT_MOC_LITERAL(6, 51, 16) // "conditionChanged"

    },
    "TaskModel\0taskAdded\0\0index\0taskRemoved\0"
    "taskUpdated\0conditionChanged"
};
...
void TaskModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->taskAdded((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->taskRemoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->taskUpdated((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->conditionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TaskModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskModel::taskAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TaskModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskModel::taskRemoved)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TaskModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskModel::taskUpdated)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (TaskModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskModel::conditionChanged)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void TaskModel::taskAdded(int _t1)
{
...
// SIGNAL 1
void TaskModel::taskRemoved(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void TaskModel::taskUpdated(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 3
void TaskModel::conditionChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
